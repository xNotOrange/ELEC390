"""
Grid based Dijkstra planning for duck transport robot
...
def main():
    ...
    # Add pond as an obstacle
    for i in range(10):
        for j in range(10):
            ox.append(25.0 + float(i))
            oy.append(40.0 + float(j))
    ...
    rx, ry = dijkstra.find_path_to_ducks(sx, sy, duck_positions)
